...
class TestRSSGeneration:
    ...
    def test_generate_feed_with_blog_posts(self):
        ...
        feed = generate_rss_feed(
            category, "https://example.com", "My Site", "My blog posts"
        )
    ...
    def test_generate_feed_no_blog_posts(self):
        ...
        root = Page(
            Path("pages.md"), Path("pages.html"), {"title": "Pages"}, "pages", True
        )

        category = Category("pages", root, [])

        feed = generate_rss_feed(category, "https://example.com", "My Site")
    ...
    def test_feed_includes_guid(self):
        ...
        assert (
            '<guid isPermaLink="true">https://example.com/blog/post.html</guid>' in feed
        )
