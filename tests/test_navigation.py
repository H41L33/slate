...
class TestNavigationGenerator:
    ...
    def test_generate_header_nav(self):
        ...
        assert (
            '<a href="projects.html" class="content-nav_header">Projects</a>'
            in nav_html
        )
    ...
    def test_generate_category_nav_with_pages(self):
        ...
        assert (
            '<a href="post1.html" class="content-nav_category">First Post</a>'
            in nav_html
        )
        assert (
            '<a href="post2.html" class="content-nav_category">Second Post</a>'
            in nav_html
        )
        assert "</ul>" in nav_html
    ...
    def test_generate_breadcrumbs_category(self):
        ...
        assert '<a href="index.html" class="breadcrumb">Home</a>' in breadcrumbs
        assert '<a href="blog.html" class="breadcrumb">My Blog</a>' in breadcrumbs
