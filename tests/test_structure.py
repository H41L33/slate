...
""")
    ...
    def test_discover_with_output_dir(self):
        ...
        assert (
            site.categories["blog"].pages[0].output_path
            == output_dir / "blog" / "post1.html"
        )
    ...
    def test_discover_tree_structure(self):
        ...
        assert (
            site.categories["blog"].root_page.output_path
            == output_dir / "pages" / "blog.html"
        )

        # blog/post1.md -> dist/pages/blog/post1.html
        assert (
            site.categories["blog"].pages[0].output_path
            == output_dir / "pages" / "blog" / "post1.html"
        )
